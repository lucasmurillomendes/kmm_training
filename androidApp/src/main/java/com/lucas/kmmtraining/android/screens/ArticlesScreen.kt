...
import com.lucas.kmmtraining.articles.domain.Article
...
fun ArticlesListView(viewModel: ArticlesViewModel) {
    val swipeRefreshState = SwipeRefreshState(viewModel.articlesState.value.loading)

    SwipeRefresh(state = swipeRefreshState, onRefresh = { viewModel.getArticles(true) }) {
